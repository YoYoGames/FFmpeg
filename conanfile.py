...
class FFMpegConan(ConanFile):
    ...
    default_options = {
        ...
        "disable_all_encoders": False,
        "disable_encoders": None,
        "enable_encoders": "aac,adpcm*,ac3,eac3,flac,mp2*,libmp3lame,opus,ra*,tta,libvorbis,wavpack,wma*,pcm*,truehd,mjpeg,tiff",
        "disable_all_decoders": False,
        "disable_decoders": None,
        "enable_decoders": "aac,ac3,adpcm*,als,atrac*,eac3,flac,gsm*,mp1*,mp2*,mp3float,mp3,mpc*,opus,ra*,ralf,shorten,tak,tta,libvorbis,wavpack,wma*,pcm*,dsd*,truehd,mjpeg,tiff",
        "disable_hardware_accelerators": None,
        "enable_hardware_accelerators": None,
        "disable_all_muxers": False,
        "disable_muxers": None,
        "enable_muxers": "image2,ac3,aiff,asf,au,avi,flac,flv,matroska,mov,m4v,mp3*,ogg,pcm*,rm,tta,wav,wv,dts,truehd",
        "disable_all_demuxers": False,
        "disable_demuxers": None,
        "enable_demuxers" : "image2,aac,ac3,aiff,ape,asf,au,avi,flac,flv,matroska,mov,m4v,mp3,mpc*,ogg,pcm*,rm,shorten,tak,tta,wav,wv,xwma,dsf,dts,truehd",
        "disable_all_parsers": False,
        "disable_parsers": None,
        "enable_parsers": "aac*,ac3,cook,dca,flac,gsm,mpegaudio,tak,vorbis",
        "disable_all_bitstream_filters": False,
        "disable_bitstream_filters": None,
        "enable_bitstream_filters": None,
        "disable_all_protocols": False,
        "disable_protocols": None,
        "enable_protocols": "file",
        "disable_all_devices": False,
        "disable_all_input_devices": False,
        "disable_input_devices": None,
        "enable_input_devices": None,
        ...
        "disable_all_filters": False,
        "disable_filters": None,
        "enable_filters": "aresample,showwavespic,atempo,asetrate,channelmap,channelsplit,aformat",
    }
